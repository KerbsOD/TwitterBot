...
def generate_meme(image_path, top_text, bottom_text='', font_path='./Program/Resources/Fonts/impact/impact.ttf', font_size=9,
                  stroke_width=5):
    ...
    # save meme
    im.save('./Program/Resources/meme-50.jpg', 'JPEG')
